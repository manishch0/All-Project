...
export const swiggy_api_URL =
  "https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.4743879&lng=77.50399039999999&page_type=DESKTOP_WEB_LISTING";
...
// Github - username
export const Github_UserName = "manishch074";
export const Github_Repository_Name = "Namaste-React";

// Github API for User
export const Github_API_User = "";
